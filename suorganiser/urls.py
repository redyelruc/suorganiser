...
from organizer.views import TagCreate, TagUpdate, TagDelete, StartupCreate, StartupUpdate, StartupDelete, NewsLinkCreate, NewsLinkUpdate, NewsLinkDelete, startup_detail, startup_list, tag_detail, tag_list
